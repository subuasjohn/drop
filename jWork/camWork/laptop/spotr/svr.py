...
class RTSPServer:
    def __init__(self):
        ...
        self.server.set_service("8555")   # instead of 8554
    ...
    def on_meta_configure(self, factory, media):
        """Start pushing metadata immediately once the media element exists."""
        ...
        GLib.timeout_add(50, push_metadata)  # push ~20 fps
